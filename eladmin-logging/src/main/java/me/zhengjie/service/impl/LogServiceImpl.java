...
public class LogServiceImpl implements LogService {
    ...
    public Object queryAll(LogQueryCriteria criteria, Pageable pageable) {
        Page<Log> page = logRepository.findAll((root, criteriaQuery, cb) -> {
            if (!SecurityUtils.getCurrentUsername().equals("admin")) {
                return cb.and(QueryHelp.getPredicate(root, criteria, cb), cb.notEqual(root.get("username"), "admin"));
            } else {
                return QueryHelp.getPredicate(root, criteria, cb);
            }
