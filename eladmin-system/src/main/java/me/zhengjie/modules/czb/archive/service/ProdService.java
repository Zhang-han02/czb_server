...
public interface ProdService {
    ...
    */
    Map<String,Object> queryAll(ProdQueryCriteria criteria, Pageable pageable);
    ...
    * @return List<ProdDto>
    */
    List<ProdDto> queryAll(ProdQueryCriteria criteria);
    ...
    * @return ProdDto
    */
    ProdDto create(Prod resources);

    /**
    * 编辑
    * @param resources /
    */
    void update(Prod resources);
    ...
    * @throws IOException /
    */
    void download(List<ProdDto> all, HttpServletResponse response) throws IOException;
     ...
     * @return
     */
    Prod findByProdNum(String prodNum);
}